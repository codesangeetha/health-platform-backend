...
export class LabTestAdminRoute {
    ...
    private initializeRoutes(): void {
        ...
        this.router.get('/lab-test-categories', authenticateToken, authorizeRoles(['patient', 'doctor', 'admin']), (req, res) => this.getLabTestCategoriesController.handle(req, res));
        this.router.get('/lab-test-categories/:id', authenticateToken, authorizeRoles(['patient', 'doctor', 'admin']), (req, res) => this.getLabTestCategoryController.handle(req, res));
        ...
        this.router.get('/lab-tests', authenticateToken, authorizeRoles(['patient', 'doctor', 'admin']), (req, res) => this.getLabTestsController.handle(req, res));
